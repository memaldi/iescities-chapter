...
Discovery among Linked Data is a major challenge for easing data integration. Due to its interlinked nature, Linked Data provides a perfect base to extend the data present in a given dataset.
