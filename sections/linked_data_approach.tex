...
One of most important concepts in Linked Data are the URIs or Unified Resource Identifier. As shown in section \ref{subsec:background}, to publish a data resource as Linked Data it has to be identified by an HTTP URI which satisfies these conditions:
\begin{itemize}
...
\begin{itemize}
    \item \textbf{303 URIs.} Use \texttt{303 See Other} status code for redirecting to the proper RDF description of the real world object. For example:
    \begin{itemize}
